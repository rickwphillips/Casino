...
public class GameUISetup : MonoBehaviour
{
    ...
    public void SetupUI()
    {
        ...
        GameObject player1Panel = CreatePanel("Player1Panel", canvasRect, new Vector2(0, 1), new Vector2(0, 1), new Vector2(10, -150), new Vector2(410, -10));
        ...
        var p1Captured = CreateText("P1Captured", player1Panel.transform, "Captured: ", 12, TextAnchor.UpperLeft, new Vector2(10, -90), new Vector2(-10, -70));

        // Player 2 Panel (Top Right)
        GameObject player2Panel = CreatePanel("Player2Panel", canvasRect, new Vector2(1, 1), new Vector2(1, 1), new Vector2(-410, -150), new Vector2(-10, -10));
        ...
        var p2Captured = CreateText("P2Captured", player2Panel.transform, "Captured: ", 12, TextAnchor.UpperRight, new Vector2(10, -90), new Vector2(-10, -70));
        ...
        GameObject gameStatePanel = CreatePanel("GameStatePanel", canvasRect, new Vector2(0.5f, 0), new Vector2(0.5f, 0), new Vector2(-200, 10), new Vector2(200, 90));
        ...
        var variant = CreateText("Variant", gameStatePanel.transform, "Variant: ", 12, TextAnchor.MiddleCenter, new Vector2(10, 25), new Vector2(-10, -35));
        var winScore = CreateText("WinScore", gameStatePanel.transform, "Win Score: 21", 12, TextAnchor.MiddleCenter, new Vector2(10, 0), new Vector2(-10, -60));
